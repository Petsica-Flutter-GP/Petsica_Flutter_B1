...
class ClinicAddPetPageViewBody extends StatefulWidget {
  const ClinicAddPetPageViewBody({super.key});

  @override
  State<ClinicAddPetPageViewBody> createState() =>
      _ClinicAddPetPageViewBodyState();
}

class _ClinicAddPetPageViewBodyState extends State<ClinicAddPetPageViewBody> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            Text("Cl Add Your Pet Information", style: Styles.textStyleQui24),
        centerTitle: true,
        leading: const AppArrowBack(destination: AppRouter.kClinicMyPet),
      ),
