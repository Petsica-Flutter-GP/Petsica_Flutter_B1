...
// class ClinicEditPetPageViewBody extends StatefulWidget {
//   const ClinicEditPetPageViewBody({super.key});

//   @override
//   State<ClinicEditPetPageViewBody> createState() =>
//       _ClinicEditPetPageViewBodyState();
// }

// class _ClinicEditPetPageViewBodyState extends State<ClinicEditPetPageViewBody> {
...
//       appBar: AppBar(
//         title:
//             Text("cl Edit Your Pet Information", style: Styles.textStyleQui24),
//         centerTitle: true,
//         leading: const AppArrowBack(destination: AppRouter.kClinicPetDetails),
//       ),
